// =====================================================
// projectController.js - Punya: Huriyah (Project)
// Sprint 6: Proteksi endpoint dengan authMiddleware
// Sprint 7: Handle upload gambar & simpan ke image_url
// =====================================================
...
// =====================================================
// POST /projects
// Buat project baru (Hanya Admin)
// =====================================================
export const createProject = async (req, res) => {
  try {
    const { title, description, target_donation, deadline } = req.body;

    // owner_id diambil dari token JWT (req.user), bukan dari body
    ...
    if (isNaN(parsedDeadline.getTime())) {
      return res.status(400).json({
        status: 'error',
        message: 'Format tanggal deadline tidak valid! Gunakan format: YYYY-MM-DD',
      });
    }

    // Ambil nama file gambar jika ada upload (Sprint 7)
    // req.file otomatis tersedia jika menggunakan upload.single('image') di routes
...
// =====================================================
// GET /projects/:id
// Ambil detail satu project (PUBLIC)
// =====================================================
...
// =====================================================
// PUT /projects/:id
// Update project (Hanya Admin) + opsional upload gambar baru
// =====================================================
export const updateProject = async (req, res) => {
  try {
    ...
    // Jika ada file gambar baru yang diupload, update image_url
    const updateData = {};
